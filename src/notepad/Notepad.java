...
boolean newFileFlag;
String fileName;
String applicationTitle="Jamilpad";
...
String applicationName="Jamilpad";
...
{
JOptionPane.showMessageDialog(Notepad.this.f,aboutText,"By Muhammad Jamil!",JOptionPane.INFORMATION_MESSAGE);
}
else
...
final String helpAboutNotepad="About Jamilpad";

final String aboutText=
	"<html><big>About Jamilpad</big><hr><hr>"
	+"<p align=right>Free and Open Source Notepad from Jamilsoft Community!"
	+"<hr><p align=left>you can Used jdk 1.8 to compile the source code.<br><br>"
	+"<strong>Thanx 4 using Jamilpad</strong><br>"
	+"Ur Comments as well as bug reports r very welcome at<p align=center>"
	+"<hr><em><big>myakububauchi@gmail.com</big></em><hr><html>";
}